namespace УП_2
{
    public partial class Form1 :Form
    {
        ...
        private void DeleteContact(object sender, EventArgs e)
        {
            ...
            {
                DialogResult dialogResult = MessageBox.Show("Точно удаляем?", "Подтверждение действия", MessageBoxButtons.YesNo); //Подтверждение действия
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Точно добавляем?", "Подтверждение действия", MessageBoxButtons.YesNo); //Подтверждение действия
            if (dialogResult == DialogResult.Yes)
            {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Точно меняем?", "Подтверждение действия", MessageBoxButtons.YesNo); //Подтверждение действия
            if (dialogResult == DialogResult.Yes)
            {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Выходим?", "Подтверждение действия", MessageBoxButtons.YesNo); //Подтверждение действия
            if (dialogResult == DialogResult.Yes)
            {
